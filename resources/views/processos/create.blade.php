    ...
    <form action="#" method="POST" class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        <div>
            <div class="ml-3 mr-3 mb-3">
                <label class="font-bold text-emerald-900 p-2 text-xl">
                    Título
                </label>
            ...
            <label class="font-bold text-emerald-900 p-2 text-xl m-3">
                Documentos relacionados
            </label>
            <div
                class="border border-slate-300 p-3 rounded-lg focus:ring-2 focus:ring-emerald-500 outline-none resize-none m-3">

                <div
                    class="border-2 border border-slate-300 rounded-xl p-8 text-center hover:border-emerald-500 transition-colors cursor-pointer bg-slate-50 m-3 mt-1">
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between bg-slate-100 p-3 m-3 rounded-lg">
                        <div class="flex items-center space-x-3">
                            <span class="bg-red-500 text-white text-[10px] font-bold px-2 py-1 rounded">
                                PDF
                            </span>
            ...
            <p class="text-slate-500 m-3">
                *Formatos permitidos: PDF, DOCS, XLSX, PNG, JPEG. Tamanho máximo: 100MB
            </p>
        </div>
        <div class="m-3">
            <label class="font-bold text-emerald-900 p-2 text-xl">
