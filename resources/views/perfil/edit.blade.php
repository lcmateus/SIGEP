        ...
        <div class="grid grid-cols-3 gap-8">
            <div class="border-r border-slate-200 pr-8">
                ...
                <div class="flex flex-col items-center">
                    <div class="w-40 h-40 rounded-full border-4 border-emerald-600 overflow-hidden shadow-md mb-6">
                        <img
                    ...
                    <label class="cursor-pointer">
                        ...
                        <div class="border border-emerald-600 text-emerald-700 px-5 py-3 rounded-lg font-bold hover:bg-emerald-50 transition-all">
                            ⬆️ Trocar imagem
                        </div>
                    </label>
